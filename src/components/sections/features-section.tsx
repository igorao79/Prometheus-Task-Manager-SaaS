        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-heading mb-2">Аналитика и отчеты</h3>
              <p className="text-muted-foreground">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-heading mb-2">Дедлайны и приоритеты</h3>
              <p className="text-muted-foreground">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-heading mb-2">Безопасность</h3>
              <p className="text-muted-foreground">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-heading mb-2">Простота использования</h3>
              <p className="text-muted-foreground">
